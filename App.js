...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
    backgroundColor: '#F3EFEE', // Cor de fundo geral
    paddingTop: 50,
  ...
  menuText: {
    fontSize: 16,
    color: '#FF9600', // Cor do texto do menu
  },
  menu: {
    marginTop: 10,
  ...
  subtitle: {
    ...
    fontWeight: 'bold',
    marginBottom: 10,
    color: '#000', // Cor do texto do subtítulo
  },
  map: {
    width: '100%',
    height: 300,
    marginBottom: 10,
    borderRadius: 20, // Aumentando o borderRadius para deixar as bordas mais ovais
  },
  header: {
    fontSize: 20,
    fontWeight: 'bold',
  ...
  input: {
    height: 40,
    borderColor: '#000', // Cor da borda do input
    borderWidth: 1,
    marginBottom: 10,
  ...
  title: {
    fontSize: 18,
    fontWeight: 'bold',
    color: '#000', // Cor do texto do título do item
  },
});
